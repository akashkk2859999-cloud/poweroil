...
export const config = {
  ...
  frontendUrl: process.env.FRONTEND_URL || 'https://poweroil-production.up.railway.app',
  jwtSecret: process.env.JWT_SECRET || 'poweroil_masterchef_nigeria_jwt_secret_replace_in_production_2024',
  campaignBaseUrl: process.env.CAMPAIGN_BASE_URL || 'https://poweroil-production.up.railway.app',
